...
import { showSuccessToast, showErrorToastFromError } from '@/lib/toast'
...
function ApiKeyActions({
  ...
  status: { exists: boolean; createdAt?: string } | undefined
  canManage: boolean
  ...
  return (
    <>
      <Dialog open={open} onOpenChange={onOpenChange}>
        <DialogContent className="max-w-md max-h-[85vh] overflow-hidden flex flex-col gap-4">
          <DialogHeader className="shrink-0">
            <DialogTitle>API Key — {projectName}</DialogTitle>
          </DialogHeader>
          <div className="space-y-4 overflow-y-auto min-h-0 pr-1">
            <p className="text-sm text-muted-foreground">
              ...
              via the public API. Authenticate with Basic Auth using username{' '}
                ...
                <div className="rounded-lg border p-4 space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <ApiKeyActions
                      ...
                      onCreate={handleCreateOrRegenerate}
